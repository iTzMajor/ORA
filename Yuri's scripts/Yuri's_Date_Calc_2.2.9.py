'''
Don't Judge Me Please, but i like salty black balls.
Owner: Yuri Boiko.
Date: 11/11/2019
Version 2.2.9
...
def input_check (var): # This function checks if the foramt of the user_input is right.
    if "\\" in var:
        return var.split("\\")
    if "/" in var :
        return var.split("/")
...
def __main__(): # this is the main table
    ...
    if date_now_checked == "invalid input":
        print("[invalid input] Please Start Again...")
        input("#\n#\n#\n#\npress \"ENTER\" to close the program.")
    elif date_birth_checked == "invalid input":
        print("[invalid input] Please Start Again...")
        input("#\n#\n#\n#\npress \"ENTER\" to close the program.")
    elif len(date_birth_checked) and len(date_now_checked) != 3:
        print("[invalid input] Please Start Again...")
        input("#\n#\n#\n#\npress \"ENTER\" to close the program.")
    ...
    # Here the program uses the function "split_calc()".
        ...
        #here the program checks if the result is positive or negative (if the result is negative, it converts the variable to a positive), and prints it out to the user.
        if days_old <= 0:
            days_old = days_old * -1
